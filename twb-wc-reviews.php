...
Text Domain:       	twb-wc-reviews

Copyright 2024 TWB Woocommerce Reviews
...
function twb_wcr_admin_notice() {
	...
	if ( ! class_exists( 'WooCommerce' ) ) {
		...
		$message = __( 'TWB Woocommerce Reviews plugin requires WooCommerce plugin to be installed and activated.', 'twb-wc-reviews' );
